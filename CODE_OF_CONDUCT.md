...
GovOps deals with legislation, policy, and decision-making about real public-sector benefits. Some additional norms apply:
...
This Code of Conduct applies within all community spaces — issues, pull requests, Discussions, commit messages, and any project-related communication — and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the project maintainers via the contact channel listed in [SECURITY.md](SECURITY.md). All complaints will be reviewed and investigated promptly and fairly.
